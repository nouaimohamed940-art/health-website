-- إعادة تعيين كاملة لقاعدة البيانات وإدراج المراكز والمستشفيات الصحيحة
-- هذا الملف سيقوم بحذف وإعادة إنشاء جدولي hospitals و centers ثم إدراج البيانات الصحيحة.

USE health_staff_management;

-- تعطيل فحص المفاتيح الخارجية مؤقتاً للسماح بالحذف وإعادة الإنشاء
...
-- إنشاء جدول hospitals (بدون عمود description)
...
-- إنشاء جدول centers (مع عمود code فريد)
