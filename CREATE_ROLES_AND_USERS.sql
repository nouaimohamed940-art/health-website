-- إنشاء جدول الأدوار والمستخدمين
...
-- إدراج الأدوار
INSERT IGNORE INTO roles (id, name, display_name, description, permissions, is_active, created_at) VALUES
(1, 'super_admin', 'مدير عام على كل المراكز', 'مدير عام له صلاحية كاملة على جميع المراكز والمستشفيات', '{"all": true}', 1, NOW()),
(2, 'hospital_manager', 'مدير المراكز', 'مدير المستشفى المشرف على المراكز التابعة له فقط', '{"hospital_centers": true, "reports": true, "approve": true}', 1, NOW()),
(3, 'center_manager', 'مدير مركز', 'مدير مركز واحد فقط، لا يرى مراكز أخرى', '{"center_only": true, "approve": true, "reports": true}', 1, NOW()),
(4, 'data_entry', 'مدخل بيانات', 'مدخل بيانات لمركز واحد فقط، يحتاج موافقة المدير', '{"data_entry": true, "center_only": true}', 1, NOW());

-- إدراج السوبر يوزر (3 حسابات)
INSERT IGNORE INTO users (id, username, password_hash, full_name, email, phone, role_id, hospital_id, center_id, is_active, created_at) VALUES
