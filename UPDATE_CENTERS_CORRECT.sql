-- تحديث المراكز بالمراكز الصحيحة التي كتبها المستخدم
-- حذف المراكز الموجودة وإضافة المراكز الصحيحة

USE health_staff_management;

-- حذف جميع المراكز الموجودة
DELETE FROM centers;

-- حذف جميع المستشفيات الموجودة
DELETE FROM hospitals;

-- إدراج المستشفيات الصحيحة
INSERT INTO hospitals (id, name, code, description, created_at) VALUES
(1, 'مجمع الملك عبد الله الطبي', 'KAMC', 'مجمع الملك عبد الله الطبي', NOW()),
(2, 'مستشفى رابغ', 'RH', 'مستشفى رابغ', NOW()),
(3, 'مستشفى الملك فهد', 'KFH', 'مستشفى الملك فهد', NOW());
...
-- إدراج المراكز الصحيحة - مستشفى رابغ (13 مركز)
INSERT INTO centers (id, hospital_id, name, code, description, is_active, created_at) VALUES
...
-- إدراج المراكز الصحيحة - مستشفى الملك فهد (12 مركز)
INSERT INTO centers (id, hospital_id, name, code, description, is_active, created_at) VALUES
