-- حل بسيط جداً - فقط إدراج البيانات بدون حذف أي شيء
USE health_staff_management;

-- فقط إدراج المستشفيات (إذا لم تكن موجودة)
INSERT IGNORE INTO hospitals (id, name, code, created_at) VALUES
(1, 'مجمع الملك عبد الله الطبي', 'KAMC', NOW()),
(2, 'مستشفى رابغ', 'RH', NOW()),
(3, 'مستشفى الملك فهد', 'KFH', NOW());

-- فقط إدراج المراكز (إذا لم تكن موجودة)
INSERT IGNORE INTO centers (id, hospital_id, name, code, description, is_active, created_at) VALUES
