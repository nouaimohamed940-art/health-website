-- نظام إدارة القوى العاملة الصحية - قاعدة البيانات المحدثة
-- Health Staff Management System - Updated Database Schema
...
-- Trigger لتسجيل أنشطة المستخدمين
CREATE TRIGGER tr_user_activity
AFTER INSERT ON activity_logs
FOR EACH ROW
BEGIN
    -- يمكن إضافة منطق إضافي هنا
    -- مثال: تحديث إحصائيات المستخدم
    -- UPDATE user_stats SET activity_count = activity_count + 1 WHERE user_id = NEW.user_id;
    SET @dummy = 1;
END //
