-- النظام الكامل المصحح لإدارة القوى العاملة الصحية
-- المراكز الصحيحة كما كتبها المستخدم
...
('مجمع الملك عبد الله الطبي', 'KAMC', 'مجمع الملك عبد الله الطبي'),
('مستشفى رابغ', 'RH', 'مستشفى رابغ'),
('مستشفى الملك فهد', 'KFH', 'مستشفى الملك فهد');

-- إدراج المراكز الصحيحة كما كتبها المستخدم
