-- نظام إدارة القوى العاملة الصحية - قاعدة البيانات المبسطة
-- Health Staff Management System - Simplified Database Schema

-- حذف قاعدة البيانات الموجودة (إذا كانت موجودة)
DROP DATABASE IF EXISTS health_staff_management;

-- إنشاء قاعدة البيانات من جديد
CREATE DATABASE health_staff_management 
...
('center_manager', 'مدير مركز', 'مدير مركز واحد فقط', '{"view_own_center": true, "edit_own_center": true, "view_own_reports": true, "export_own_reports": true, "manage_own_employees": true}'),
('hospital_supervisor', 'مدير المراكز', 'مدير على جميع مراكز مستشفى واحد', '{"view_hospital_centers": true, "view_hospital_reports": true, "export_hospital_reports": true, "approve_requests": true, "view_hospital_employees": true}'),
('super_admin', 'مدير عام على كل المراكز', 'مدير عام على جميع المراكز والمستشفيات', '{"view_all_centers": true, "view_all_reports": true, "export_all_reports": true, "manage_all_users": true, "manage_all_employees": true, "system_settings": true}');

-- إدراج المستخدمين
-- مدير عام على كل المراكز (2 حسابات)
INSERT INTO users (username, email, password_hash, full_name, phone, role_id, hospital_id, center_id) VALUES
('super_admin_1', 'admin1@health.gov.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدير عام على كل المراكز الأول', '0501234567', 3, NULL, NULL),
('super_admin_2', 'admin2@health.gov.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدير عام على كل المراكز الثاني', '0501234568', 3, NULL, NULL);

-- مديري المراكز (3 حسابات)
INSERT INTO users (username, email, password_hash, full_name, phone, role_id, hospital_id, center_id) VALUES
('kfsh_supervisor', 'supervisor@kfsh.med.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدير المراكز - مستشفى الملك فهد', '0501234569', 2, 1, NULL),
('kau_supervisor', 'supervisor@kau.edu.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدير المراكز - مستشفى الملك عبدالعزيز', '0501234570', 2, 2, NULL),
('kkuh_supervisor', 'supervisor@kkuh.med.sa', '$2y$10$92IXUNpkjO0rOQ5byMi.Ye4oKoEa3Ro9llC/.og/at2.uheWG/igi', 'مدير المراكز - مستشفى الملك خالد', '0501234571', 2, 3, NULL);
...
-- إنشاء مستخدم قاعدة البيانات (بدون FLUSH PRIVILEGES)
